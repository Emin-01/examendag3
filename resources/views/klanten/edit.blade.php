    ...
    <div class="max-w-2xl mx-auto mt-10 bg-white rounded-lg shadow border border-gray-200 p-6">
        ...
        <form method="POST" action="{{ route('klanten.update', $klant['id'] ?? 1) }}">
            ...
            <div class="flex flex-wrap gap-2 justify-end">
                ...
                <a href="{{ route('klanten.show', $klant['id'] ?? 1) }}" class="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded font-semibold text-base shadow transition">Terug</a>
