        ...
        <form method="POST" action="{{ route('klanten.update', $klant['id'] ?? 1) }}">
            ...
            <table class="w-full mb-8 border border-gray-200 rounded">
                <tbody>
                    ...
                    <tr><td class="py-2 px-4 font-semibold">Vertegenwoordiger</td><td class="py-2 px-4">
    <input type="text" name="vertegenwoordiger" class="w-full border rounded px-2 py-1" value="{{ is_array($klant['vertegenwoordiger'] ?? null) ? '' : ($klant['vertegenwoordiger'] ?? '') }}">
</td></tr>
